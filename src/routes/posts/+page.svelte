...
<section class="max-w-default mx-auto flex flex-col px-5 lg:px-0">
    <div class="w-full grid md:grid-cols-3 gap-12 md:gap-7">

        {#await fetchPosts()}
            {#each {length:6}}
            
        <article class="w-full max-w-80 mx-auto md:mx-0" draggable="false">
        ...
        <article class="w-full max-w-80 group mx-auto md:mx-0" draggable="false">
            <div class="w-full flex flex-col relative space-y-2">
